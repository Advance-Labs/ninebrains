...
working-tree mirror followed symlinks). T36 is open: upstream git runs lane-controlled config
outside any sandbox. The new accepted risks are R16 and R17.
