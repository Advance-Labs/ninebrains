...
## 51. Notification pruning has never run (`ninebrains/notifications-prune`)
...
| `docs/strategy/decisions.md` | L0's decision log: context, decision, alternatives, reversibility, owners | Four entries so far, including the split precedence rule and the program's own conflict-of-interest mitigations |
