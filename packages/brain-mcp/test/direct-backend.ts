 ...
 */
import { type Brain, type BrainGrant, executeBrainRequest } from '@ninebrains/brain-core';
import type { BrainBackend } from '../src/backend';

export function directBackend(brain: Brain, grant: BrainGrant): BrainBackend {
  return {
